  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.token) {
          // ¿Hay token? Si lo hay lo guardo en un localStorage
    ...
    <nav style={{ backgroundColor: "grey" }}>
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          {isLoggedIn ? (
            <>
              <Link href="/bibliotecatic/admin/libros"> Admin Libros </Link>
              <Link href="/bibliotecatic/admin/autores"> Admin Autores </Link>
